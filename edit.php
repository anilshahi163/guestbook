<?php include("server.php");
	if (isset($_GET['id'])) {
		...
		$name = mysqli_real_escape_string($con,$record['name']);
	
		$address = mysqli_real_escape_string($con,$record['address']);
		$email = mysqli_real_escape_string($con,$record['email']);
		$number = mysqli_real_escape_string($con,$record['Mobile_number']);
